...
public class HashedDictionary<K, V> implements DictionaryInterface<K, V>
{
    ...
    private static final int DEFAULT_CAPACITY = 111; // Must be prime, MAKE THIS MORE THAN 100 WITH A PRIME NUMBER, regular number is 5
    ...
    // contains is not required for this project, but it make it easier
